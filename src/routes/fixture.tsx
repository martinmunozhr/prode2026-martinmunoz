  ...
  head: () => ({
    meta: [
      { title: "Fixture Mundial 2026 — Calendario completo" },
      {
        name: "description",
        content:
          "Calendario completo del Mundial 2026: todos los partidos por grupo, sede y fecha.",
      },
      { property: "og:title", content: "Fixture Mundial 2026" },
      {
        property: "og:description",
        content: "Calendario completo de los 104 partidos del Mundial 2026.",
      },
    ],
  }),
...
function FixturePage() {
  ...
  const knockoutMatches = stageMatches.sort(
        ...
        <>
          ...
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-6">
            <div className="space-y-6">
              ...
              <div className="hidden lg:flex relative rounded-2xl border border-border/40 bg-gradient-card overflow-hidden h-[340px] flex-col items-center p-4">
                ...
                <img
                  ...
                  alt=""
                  aria-hidden
                  className="absolute inset-x-0 bottom-0 mx-auto h-[260px] object-contain object-bottom pointer-events-none drop-shadow-2xl"
                  loading="lazy"
                  decoding="async"
                />
              </div>
